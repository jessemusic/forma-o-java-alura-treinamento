package br.com.jessemusic;
	...
	public class TesteListas {
	    ...
	    public static void main(String[] args) {
	        ...
	        System.out.println("Inserção na ArrayList demorou  " + tempoArrayList +" mili-segundos");
	        System.out.println("Inserção na LinkedList demorou " + tempoLinkedList +" mili-segundos");

	        tempoArrayList = removePrimeirosElementos(numerosArrayList);
	        tempoLinkedList = removePrimeirosElementos(numerosLinkedList);

	        System.out.println("Remoção da ArrayList demorou  " + tempoArrayList +" mili-segundos");
	        System.out.println("Remoção da LinkedList demorou " + tempoLinkedList +" mili-segundos");
	    }
